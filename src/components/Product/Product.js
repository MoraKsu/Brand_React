          ...
          <div className="product__card" key={product.id}>
            ...
            <div className="product__card-add">
              ...
              >
                ...
                <p className="product__txt">Add to Cart</p>
              </button>
            </div>
          </div>
        ))}
      </div>
      <div className="product__btn__catalog">
        <div className="product__btn">
          <Link to="/catalog" className="product__catalog">
            Browse All Products <ArrowForwardIcon />
          </Link>
        </div>
      </div>
    </section>
